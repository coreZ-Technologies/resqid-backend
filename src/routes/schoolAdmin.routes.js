...
import attendanceRoutes from '#modules/school-admin/attendance/attendance.routes.js';
import deviceRoutes from '#modules/school-admin/attendance/attendance-devices.routes.js';
